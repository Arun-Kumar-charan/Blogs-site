...
if(!function_exists('weaversweb_ftn_options')){
	function weaversweb_ftn_options(){
		...
		array("name" => "Choose Site Light Logo",
			  ...
			  "std"  => "",
			  "type" => "upload"),
			  array("name" => "Footer Description Title",
			  "desc" => "Enter Footer Description Title",
			  "id"   => "bc_footer_desc_title",
			  "std"  => "",
			  "type" => "textarea"),
		...
		array("name" => "Footer Description",
			  ...
			  "std"  => "",
			  "type" => "textarea"),
			  array("name" => "Footer Menu Subscribe To Newsletter:",
			  "desc" => "Enter Footer Menu Subscribe To Newsletter:",
			  "id"   => "bc_footer_menu_subscribe",
			  "std"  => "",
			  "type" => "text"),
			  array("name" => "Footer Menu QUICK LINKS:",
			  "desc" => "Enter Footer Menu QUICK LINKS:",
			  "id"   => "bc_footer_menu_quick_links",
			  "std"  => "",
			  "type" => "text"),
		...
		array("name" => "Footer Newsletter Description",
			  ...
			  "std"  => "",
			  "type" => "textarea"),
			  array("name" => "footer right section title",
			  "desc" => "Enter title",
			  "id"   => "right_section_title",
			  "std"  => "",
			  "type" => "text"),
			  array("name" => "footer right section link1",
			  "desc" => "Enter Link1",
			  "id"   => "link1",
			  "std"  => "",
			  "type" => "text"),
			  array("name" => "footer right section link2",
			  "desc" => "Enter Link2 ",
			  "id"   => "link2",
			  "std"  => "",
			  "type" => "text"),
			  array("name" => "footer right section link3",
			  "desc" => "Enter Link3",
			  "id"   => "link3",
			  "std"  => "",
			  "type" => "text"),
